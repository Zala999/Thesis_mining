...
def assess_performance(config, network, loader, current_epoch=-1):
    ...
    plt.show()
    plt.savefig('confusion_matrix_resnet50_66.png')
...
for current_fold in CFG.train_folds:
    ...
    for epoch in range(CFG.epochs):
        ...
        if val_f1_score > best_f1_score:
            ...
            torch.save(model.state_dict(), f'/home/u387021/thesis/mining/best_model_VT_resnet50_66_fold_{FOLD}.pth')
    ...
    fig.tight_layout()
    plt.savefig('history_resnet50_66')
    plt.show()
...
for FOLD in CFG.train_folds:
    ...
    model.load_state_dict(torch.load(f"/home/u387021/thesis/mining/best_model_VT_resnet50_66_fold_{FOLD}.pth", map_location=CFG.device))
...
test_data[["file_name", "label"]].to_csv("/home/u387021/thesis/mining/submission_resnet50_66.csv", index=False, header=None)
