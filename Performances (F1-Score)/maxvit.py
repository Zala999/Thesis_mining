...
train_preprocess = v2.Compose([
    ...
    v2.Resize((512, 512)), #Resize the image
...
def assess_performance(config, network, loader, current_epoch=-1):
    ...
    plt.show()
    plt.savefig('confusion_matrix_maxvit777.png')
...
class CFG:
    ...
    model_name = 'maxvit_tiny_tf_512' #Specifying model name to be used
...
for current_fold in CFG.train_folds:
    ...
    for epoch in range(CFG.epochs):
        ...
        if val_f1_score > best_f1_score:
            ...
            torch.save(model.state_dict(), f'/home/u387021/thesis/mining/best_model_VT_maxvit_tiny777_fold_{FOLD}.pth')
    ...
    fig.tight_layout()
    plt.savefig('history_VTmaxvit_777')
    plt.show()
...
test_resize = v2.Compose([
    ...
    v2.Resize((512, 512)),  #Resizing images for model compatibility
    v2.ToDtype(torch.float32, scale=False),])
...
for FOLD in CFG.train_folds:
    ...
    model.load_state_dict(torch.load(f"/home/u387021/thesis/mining/best_model_VT_maxvit_tiny777_fold_{FOLD}.pth", map_location=CFG.device))
...
test_data[["file_name", "label"]].to_csv("/home/u387021/thesis/mining/submission_VTmaxvit_tiny777.csv", index=False, header=None)
