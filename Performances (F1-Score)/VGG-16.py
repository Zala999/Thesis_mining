...
def assess_performance(config, network, loader, current_epoch=-1):
    ...
    plt.show()
    plt.savefig('confusion_matrix_vgg16_9.png')
...
class CFG:
    ...
    model_name = 'vgg16' #Specifying model name to be used
...
for current_fold in CFG.train_folds:
    ...
    for epoch in range(CFG.epochs):
        ...
        if val_f1_score > best_f1_score:
            ...
            torch.save(model.state_dict(), f'/home/u387021/thesis/mining/best_model_VT_vgg16_9_fold_{FOLD}.pth')
...
for FOLD in CFG.train_folds:
    ...
    model.load_state_dict(torch.load(f"/home/u387021/thesis/mining/best_model_VT_vgg16_9_fold_{FOLD}.pth", map_location=CFG.device))
...
test_data[["file_name", "label"]].to_csv("/home/u387021/thesis/mining/submission_vgg16_9.csv", index=False, header=None)
