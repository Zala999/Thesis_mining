...
def assess_performance(config, network, loader, current_epoch=-1):
    ...
    plt.show()
    plt.savefig('confusion_matrix_swin_base95.png')
...
class CFG:
    ...
    model_name = 'swin_base_patch4_window7_224_in22k' #Specifying model name to be used
...
for current_fold in CFG.train_folds:
    ...
    for epoch in range(CFG.epochs):
        ...
        if val_f1_score > best_f1_score:
            ...
            torch.save(model.state_dict(), f'/home/u387021/thesis/mining/best_model_VT_swin_base95_fold_{FOLD}.pth')
    ...
    fig.tight_layout()
    plt.savefig('history_VTswin_base95')
    plt.show()
...
for FOLD in CFG.train_folds:
    ...
    model.load_state_dict(torch.load(f"/home/u387021/thesis/mining/best_model_VT_swin_base95_fold_{FOLD}.pth", map_location=CFG.device))
...
test_data[["file_name", "label"]].to_csv("/home/u387021/thesis/mining/submission_VTswin_base95.csv", index=False, header=None)
