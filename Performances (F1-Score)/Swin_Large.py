...
train_preprocess = v2.Compose([
    ...
    v2.Resize((384, 384)), #Resize the image
...
def assess_performance(config, network, loader, current_epoch=-1):
    ...
    plt.show()
    plt.savefig('confusion_matrix_swin444.png')
...
class CFG:
    ...
    model_name = "swin_large_patch4_window12_384" #Specifying model name to be used
...
for current_fold in CFG.train_folds:
    ...
    for epoch in range(CFG.epochs):
        ...
        if val_f1_score > best_f1_score:
            ...
            torch.save(model.state_dict(), f'/home/u387021/thesis/mining/best_model_VT_swin444_fold_{FOLD}.pth')
...
test_resize = v2.Compose([
    ...
    v2.Resize((384, 384)),  #Resizing images for model compatibility
    v2.ToDtype(torch.float32, scale=False),])
...
for FOLD in CFG.train_folds:
    ...
    model.load_state_dict(torch.load(f"/home/u387021/thesis/mining/best_model_VT_swin444_fold_{FOLD}.pth", map_location=CFG.device))
...
test_data[["file_name", "label"]].to_csv("/home/u387021/thesis/mining/submission_VTswin444.csv", index=False, header=None)
