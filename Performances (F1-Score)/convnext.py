...
def assess_performance(config, network, loader, current_epoch=-1):
    ...
    plt.show()
    plt.savefig('confusion_matrix_convnext_base_10.png')
...
class CFG:
    ...
    model_name = 'convnext_base' #Specifying model name to be used
...
for current_fold in CFG.train_folds:
    ...
    for epoch in range(CFG.epochs):
        ...
        if val_f1_score > best_f1_score:
            ...
            torch.save(model.state_dict(), f'/home/u387021/thesis/mining/best_model_VT_convnext_base_10_fold_{current_fold}.pth')
    ...
    fig.tight_layout()
    plt.savefig('training_validation_history_convnext_base_10')
    plt.show()
...
for FOLD in CFG.train_folds:
    ...
    model.load_state_dict(torch.load(f"/home/u387021/thesis/mining/best_model_VT_convnext_base_10_fold_{FOLD}.pth", map_location=CFG.device))
...
test_data[["file_name", "label"]].to_csv("/home/u387021/thesis/mining/submission_convnext_base_10.csv", index=False, header=None)
